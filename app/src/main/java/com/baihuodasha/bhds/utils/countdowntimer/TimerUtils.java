...
public class TimerUtils {
    ...
    public static String[] getNumInTimerStr(String mTimerStr){
        //String[] string  =  mTimerStr.split("[^\\d]");
        //String[] timeS  = new String[]{};
        //String stringArr = StringUtils.join(string);
        //char[] time = stringArr.toCharArray();
     //   Log.i("qaz", "getNumInTimerStr: "+stringArr);
       // Log.i("qaz", "getNumInTimerStr: "+string);
