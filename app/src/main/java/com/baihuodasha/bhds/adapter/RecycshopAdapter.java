...
public class RecycshopAdapter extends RecyclerView.Adapter<RecycshopAdapter.MyViewHolder> {
  ...
  @Override
  public RecycshopAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(mContext).inflate(R.layout.recycshop_item, parent, false);
    return new MyViewHolder(view);
  }

  @Override public void onBindViewHolder(RecycshopAdapter.MyViewHolder holder, final int position) {
    //
