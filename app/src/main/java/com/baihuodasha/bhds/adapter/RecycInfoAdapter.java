...
public class RecycInfoAdapter extends RecyclerView.Adapter<RecycInfoAdapter.MyViewHolder> {

  private final FragmentActivity mContext;
  private List<ParentInfo> newlist;
  public RecycInfoAdapter(FragmentActivity mContext,List<ParentInfo> mList) {
  ...
  @Override public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    return new RecycInfoAdapter.MyViewHolder(view);
  }
  ...
  @Override public void onBindViewHolder(MyViewHolder holder, int position) {
    ...
    if (holder.mItemrecycinfo.getAdapter() == null) {
      holder.mItemrecycinfo.setAdapter(new ChildInfoAdapter(mContext, newlist.get(position).getMenuList()));
    } else {
