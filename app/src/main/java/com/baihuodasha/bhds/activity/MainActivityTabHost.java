...
import com.baihuodasha.bhds.fragment.FragmentMiddle;
...
import static com.baihuodasha.bhds.utils.StatusBarUtil.setColorNoTranslucent;
...
public class MainActivityTabHost extends FragmentActivity {
	...
	//超市
	FragmentMiddle csFragment = new FragmentMiddle();
	...
	private FragmentMiddle fragment1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setColorNoTranslucent(this, R.color.titleBar);

    //
		if (null != savedInstanceState) {
			manager = getSupportFragmentManager();
			fragment0 = (FragmentHome) manager.getFragment(savedInstanceState, "FragmentHome");
			fragment1 = (FragmentMiddle) manager.getFragment(savedInstanceState, "FragmentMiddle");
