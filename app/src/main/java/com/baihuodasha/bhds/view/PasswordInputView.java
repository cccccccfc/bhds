...
public class PasswordInputView extends EditText{
     ...
     * 间隔
     */
//    private final int PWD_SPACING = dip2px(getContext(),12);
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        mRectPaint.setColor(Color.rgb(153,153,153));
        mRectPaint.setAntiAlias(true);
        //内容画笔
        mNRPaint=new Paint();
        mNRPaint.setStyle(Paint.Style.FILL);
        mNRPaint.setColor(Color.rgb(255,255,255));
        mNRPaint.setAntiAlias(true);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < PWD_LENGTH; i++) {
            ...
            //设置密码框的背景颜色
//            canvas.drawRect(mRect,mNRPaint);
        }
        // 内容区
