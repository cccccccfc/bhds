...
public class WheelOptions<T> {
  ...
  private WheelView.DividerType dividerType;
        ...
        @Override public void onItemSelected(int index) {
          ...
          if (mOptions2Items == null) {//只有1级联动数据
            ...
            if (!isRestoreItem) {
              ...
              opt2Select =
                  opt2Select >= mOptions2Items.get(index).size() - 1 ? mOptions2Items.get(index)
                      .size() - 1 : opt2Select;
            }
    ...
    private void setDividerColor() {
      int dividerColors = 0xFFF4F4F4;
      wv_option1.setDividerColor(dividerColors);
        wv_option2.setDividerColor(dividerColors);
        wv_option3.setDividerColor(dividerColors);
    }
